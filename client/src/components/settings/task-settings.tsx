    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="auto-generate-days">Generate Tasks Before End Date</Label>
              <Input 
              ...
              <p className="text-xs text-muted-foreground">
                Number of days before compliance end date to auto-generate recurring tasks
              </p>
            </div>
            
            <div className="flex items-center justify-between py-2">
              <div>
                <Label htmlFor="allow-past-dates">Allow Past Due Dates</Label>
                <p className="text-sm text-muted-foreground">Allow setting task due dates in the past</p>
              </div>
              <Switch 
                id="allow-past-dates" 
