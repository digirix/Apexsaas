...
export function TaxJurisdictionsManager() {
  ...
  function handleEdit(jurisdiction: TaxJurisdiction) {
    ...
    form.reset({ 
      ...
      stateId: jurisdiction.stateId ? jurisdiction.stateId.toString() : "",
    });
                    ...
                    >
                      ...
                      <SelectContent>
                        {!watchCountryId ? (
                          ...
                          <SelectItem value="">No states available for this country</SelectItem>
                        ) : (
                          <>
                            <SelectItem value="">No specific state (country-wide)</SelectItem>
