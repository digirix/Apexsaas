                  ...
                  <TableRow key={task.id} className="cursor-pointer hover:bg-muted/50" onClick={() => handleViewTask(task)}>
                    ...
                    <TableCell>
                      <div className="flex items-center">
                        ...
                        {task.updatedAt ? format(new Date(task.updatedAt), "MMM d, yyyy") : "N/A"}
                      </div>
                    </TableCell>
                  </TableRow>
                ))}
            ...
            <DialogFooter>
              <div className="w-full flex justify-between items-center">
                <div className="text-sm text-muted-foreground">
                  <span className="font-semibold">Approval Date:</span> {selectedTask.updatedAt ? format(new Date(selectedTask.updatedAt), "MMM d, yyyy") : "N/A"}
                </div>
              </div>
            </DialogFooter>
          </DialogContent>
