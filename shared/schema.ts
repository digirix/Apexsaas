...
export const tasks = pgTable("tasks", {
  ...
  // Parent-child relationship for recurring tasks
  parentTaskId: integer("parent_task_id"), // ID of the parent recurring task or approved auto-generated task
  // Fields for auto-generated tasks (single-table approach)
  isAutoGenerated: boolean("is_auto_generated").default(false), // Whether this is an auto-generated task
  needsApproval: boolean("needs_approval").default(false), // Whether this auto-generated task needs approval
  // Task state fields
...
// Auto-generated tasks table (separate from regular tasks)
export const autoGeneratedTasks = pgTable("auto_generated_tasks", {
  id: serial("id").primaryKey(),
  tenantId: integer("tenant_id").notNull(),
  ...
  isRecurring: boolean("is_recurring").default(false).notNull(),
  // Compliance fields
  complianceFrequency: text("compliance_frequency"),
  complianceYear: text("compliance_year"),
  complianceDuration: text("compliance_duration"),
  complianceStartDate: timestamp("compliance_start_date"),
  complianceEndDate: timestamp("compliance_end_date"),
  compliancePeriod: text("compliance_period"),
  // Invoice information
  currency: text("currency"),
  serviceRate: doublePrecision("service_rate"),
  invoiceId: integer("invoice_id"),
  parentTaskId: integer("parent_task_id"),
  needsApproval: boolean("needs_approval").default(true).notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});

// Define type for auto-generated tasks
export type AutoGeneratedTask = typeof autoGeneratedTasks.$inferSelect;
export type InsertAutoGeneratedTask = z.infer<typeof insertAutoGeneratedTaskSchema>;

export const insertAutoGeneratedTaskSchema = createInsertSchema(autoGeneratedTasks)
  .pick({
    tenantId: true,
    isAdmin: true,
    taskType: true,
  ...
  .extend({
    ...
    needsApproval: z.boolean().default(true).optional(),
  });
