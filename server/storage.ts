...
// We'll use any type for auto-generated tasks for now
// This will be replaced with proper types when we implement the database storage
...
export interface IStorage {
  ...
  getAutoGeneratedTasks(tenantId: number, clientId?: number, entityId?: number, needsApproval?: boolean): Promise<any[]>;
  getAutoGeneratedTask(id: number, tenantId: number): Promise<any | undefined>;
  createAutoGeneratedTask(task: any): Promise<any>;
  updateAutoGeneratedTask(id: number, task: any): Promise<any | undefined>;
  deleteAutoGeneratedTask(id: number, tenantId: number): Promise<boolean>;
  approveAutoGeneratedTask(id: number, tenantId: number): Promise<boolean>;
  ...
  getAutoGeneratedTasksByApprovalStatus(
    tenantId: number,
    needsApproval: boolean
  ): Promise<AutoGeneratedTask[]>;
  getAutoGeneratedTask(id: number, tenantId: number): Promise<AutoGeneratedTask | undefined>;
  createAutoGeneratedTask(task: InsertAutoGeneratedTask): Promise<AutoGeneratedTask>;
  updateAutoGeneratedTask(id: number, task: Partial<InsertAutoGeneratedTask>): Promise<AutoGeneratedTask | undefined>;
  deleteAutoGeneratedTask(id: number, tenantId: number): Promise<boolean>;
  approveAutoGeneratedTask(id: number, tenantId: number): Promise<boolean>;
}
