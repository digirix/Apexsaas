  ...
  public async approveTask(taskId: number, tenantId: number): Promise<boolean> {
    try {
      ...
      try {
        ...
        // Create a new regular task that's a copy of the auto-generated task,
        // but with isAutoGenerated=false to move it to the main Tasks module
        // and with needsApproval=false to indicate it's been approved
        const taskUpdate: any = {
          isAutoGenerated: false, // This is critical: making it false moves it to the regular Tasks module
