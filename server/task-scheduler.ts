...
export class TaskScheduler {
  ...
  public async approveTask(taskId: number, tenantId: number): Promise<boolean> {
    try {
      ...
      // We're only looking for a direct match with the same ID as parent
      ...
      if (task.parentTaskId) {
        ...
        // Only get sibling tasks that share the SAME parent task ID (important for distinguishing tasks)
        // This ensures we're only comparing tasks that came from the same original parent task
