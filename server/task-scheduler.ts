...
export class TaskScheduler {
  ...
  private async createRecurringTaskInstance(
    ...
    try {
      ...
      // Prepare the new task data with camelCase fields to match the expected InsertAutoGeneratedTask type
      const newTaskData = {
        ...
        compliancePeriod: `${format(complianceStartDate, 'MMM yyyy')}`,
